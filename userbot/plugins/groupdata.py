...
async def _(event):
    if event.fwd_from:
        return
    mentions = "𓆩 𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐄𝐎 𝑮𝑹𝑶𝑼𝑷 𝑫𝑨𝑻𝑨 𓆪\n** ⪼ المشرفـون في ۿذه المجموعه :** \n"
    reply_message = None
...
async def _(event):
    ...
    async for i in bot.iter_participants(event.chat_id):
        ...
        if i.bot:
            ...
            n += 1
    if input_str:
        required_string = """𓆰 𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐄𝐎 - 𝐆𝐑𝐎𝐔𝐏 𝐒𝐓𝐀𝐓𝐒 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 
...
async def fetch_info(chat, event):
    ...
    caption = "<b> 𓆰 𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐄𝐎  - 𝑮𝑹𝑼𝑶𝑷 𝑫𝑨𝑻𝑨 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 </b>\n"
    ...
    if hasattr(chat_obj_info, "scam") and chat_obj_info.scam:
        ...
        caption = f"<b>𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝘿𝙀𝙑 - @QHR_1 𓆪</b>"
    return caption
