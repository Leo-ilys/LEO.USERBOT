...
MSGE = (
   f"𓆰 𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐄𝐎 - 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⌔∮ المستخدم -** {mention}\n**⌔∮ البوت - {TBOT}**\n**⌔∮ للمساعده - {DEVL}**\n**اكتب {T}بنك لتحقق اذا ما كان البوت يعمل**"
)

Tlk = " تم استرداد ⫸"
IS = "⫷ لايمكن تحميل - {} بسبب {} ⫸"

#- AYA is the most beautiful girl in the world -#
ICSJ = "<ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ>"
StartLoaded = "<ⵧⵧⵧⵧⵧⵧ⫷ - LEO PLUGINS - ⫸ⵧⵧⵧⵧⵧⵧ>"
ASSISTANT = "<ⵧⵧⵧⵧⵧⵧ⫷ - LEO ASSISTANT - ⫸ⵧⵧⵧⵧⵧⵧ>"
KIMOTOSHA = "<ⵧⵧⵧⵧⵧⵧⵧⵧ⫷ - LEO AYA - ⫸ⵧⵧⵧⵧⵧⵧⵧ>"
ANIMATIONS = "<ⵧⵧⵧⵧⵧⵧ⫷ - LEO ANIMATIONS - ⫸ⵧⵧⵧⵧⵧ>"
ADMIN = "<ⵧⵧⵧⵧⵧ⫷ - LEO ADMIN TOOLS - ⫸ⵧⵧⵧⵧⵧ>"
ASSISTANTPM = "<ⵧⵧⵧⵧⵧ⫷ - LEO ASSISTANT PM - ⫸ⵧⵧⵧⵧⵧ>"
...
Message = (
"""       ⫷ بوت ليو يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
⫷ @QHR_1 - اذا كنت بحاجه الى مساعده فتوجه الى ⫸"""
)

Mesg = [
    '⫷ يتم تحميل انلاين ليو ⫸',
    '⫷ اكتمل تنزيل انلاين ليو بدون اخطاء ⫸',
    '⫷ يتم بدء بوت ليو ⫸',
    '⫷ اكتمل بدء بوت ليو ⫸'
]
